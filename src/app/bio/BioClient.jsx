...
const profileData = {
  ...
  hobbies: [
    ...
    { name: "Photography", emoji: "📸", description: "Landscape and wildlife" },
    {
      name: "Hiking",
      emoji: "🥾",
      description: "Mountain and countryside walks",
    },
    {
      name: "Krav Maga",
      emoji: "🥋",
      description: "Self-defence and technique",
    },
    {
      name: "Piano",
      emoji: "🎹",
  ...
  qualifications: {
    current: [
      ...
      {
        subject: "AS Level Computer Science",
        grade: "B (Achieved)",
        level: "AS Level",
      },
      {
        subject: "EAL Engineering",
    ...
    achieved: [
      ...
      {
        subject: "Cambridge Nationals Engineering",
        grade: "Distinction*",
        level: "Cambridge",
      },
              ...
              >
                {profileData.interests.map((interest, index) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`${interest.color} p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-200`}
                      >
