        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              ...
              journey in photography began when I received my first camera as a
              teenager, and Ive been passionate about visual storytelling ever
              since.
            </p>
            <p className="text-lg text-gray-600 mb-6">
              With a background in fine arts and a keen eye for detail, I
              approach each photography session with creativity and
              professionalism. I believe that great photography goes beyond just
              taking pictures – its about creating an experience and preserving
              memories that will last a lifetime.
            </p>
            <p className="text-lg text-gray-600 mb-6">
              When Im not behind the camera, you can find me exploring new
              locations for shoots, attending photography workshops to refine my
              skills, or spending time with my family and our golden retriever.
            </p>
            <div className="mt-8">
              <Link
                href="/contact"
