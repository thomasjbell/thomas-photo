...
const linksClass =
  "text-base md:text-lg text-mono-200 hover:text-mono-100 dark:text-mono-300 dark:hover:text-mono-200 transition-colors duration-250 ease-in-out";
  ...
  return (
    <footer className="bg-mono-400 text-mono-300 dark:bg-mono-500 dark:text-mono-300 py-12 border-t border-mono-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/Projects" prefetch={true} className={linksClass}>
                  Projects
                </Link>
              </li>
              <li>
        ...
        >
          <p className="text-sm md:text-base text-mono-300">
