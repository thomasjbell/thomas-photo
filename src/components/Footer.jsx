...
const linksClass = "text-lg text-mono-200 hover:text-mono-100 dark:text-mono-300 dark:hover:text-mono-200 transition-colors duration-250 ease-in-out";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          <motion.div variants={itemVariants}>
            <h3 className="text-5xl font-bold mb-4 text-mono-200">Thomas J Bell</h3>
            <p className="text-mono-200 dark:text-mono-300 text-lg">
        ...
        <motion.div
          className="border-t border-mono-300 dark:border-mono-400 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center"
