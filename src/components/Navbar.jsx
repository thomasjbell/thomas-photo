...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="hidden md:flex fixed left-0 top-0 h-screen w-20 lg:w-16 backdrop-blur-md bg-mono-500 dark:bg-mono-50 z-50 shadow-lg shadow-slate-300/20 dark:shadow-slate-900/40 flex-col items-center py-8">
        {/* Logo at top */}
        <motion.div
      ...
      <nav className="md:hidden backdrop-blur-md bg-slate-200/50 dark:bg-slate-900/60 sticky top-0 z-50 shadow-lg shadow-slate-300/20 dark:shadow-slate-900/40">
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className="backdrop-blur-md bg-slate-100/95 dark:bg-slate-900/95 border-t border-slate-200/50 dark:border-slate-700/50 shadow-lg shadow-slate-300/10 dark:shadow-slate-900/20 overflow-hidden"
            >
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                >
                  <div className="flex justify-centre space-x-8 pb-2">
                    <motion.a
                      href="https://instagram.com/thomas.j.bell"
                      target="_blank"
                      rel="noopener noreferrer"
