...
export default function Navbar() {
  ...
  return (
    <>
        ...
        >
          ...
          <div className="flex flex-col items-center gap-6 mt-2">
            <motion.a
              ...
              className="text-mono-50/60 dark:text-mono-500/60 hover:text-mono-50 dark:hover:text-mono-500 transition-all duration-200"
      ...
      {/* Mobile Horizontal Navbar — unchanged */}
      <nav className="md:hidden backdrop-blur-md bg-mono-200/50 dark:bg-mono-500/60 sticky top-0 z-50 shadow-lg shadow-mono-300/20 dark:shadow-mono-500/40">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center gap-3">
              <motion.div
                ...
                transition={{ duration: 0.2 }}
              >
                <Logo className="fill-mono-500 dark:fill-mono-50" />
              </motion.div>
              <Link
                href="/"
                className="font-bold font-fira text-xl text-mono-500 dark:text-mono-50 hover:text-mono-400 dark:hover:text-mono-100 transition-colors duration-200"
              >
                T&nbsp;H&nbsp;O&nbsp;M&nbsp;A&nbsp;S &nbsp; J &nbsp;
                B&nbsp;E&nbsp;L&nbsp;L
              </Link>
            ...
            <div className="flex items-center">
              <button
                ...
                className="text-mono-300 hover:text-mono-500 dark:text-mono-50 dark:hover:text-mono-200 focus:outline-none p-2 rounded-lg hover:bg-mono-200/50 dark:hover:bg-mono-400/50 transition-colors duration-200"
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              transition={{ duration: 0.2, ease: "easeOut" }}
              className="backdrop-blur-md bg-mono-100/95 dark:bg-mono-500/95 border-t border-mono-200/50 dark:border-mono-500/50 shadow-lg shadow-mono-300/10 dark:shadow-mono-500/20 overflow-hidden"
            >
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                {[
                  ...
                  >
                    <Link
                      href={item.href}
                      className="block px-3 py-3 text-mono-400 hover:text-mono-500 dark:text-mono-50 dark:hover:text-mono-300 transition-colors duration-200 rounded-lg hover:bg-mono-200/50 dark:hover:bg-mono-500/50"
                ...
                <motion.div
                  ...
                  className="pt-4 border-t border-mono-300/50 dark:border-mono-500/50 mt-4"
                >
                  <div className="flex justify-center space-x-8 pb-2">
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-mono-300 hover:text-mono-500 dark:text-mono-300 dark:hover:text-mono-100 transition-all duration-200 p-2 rounded-full hover:bg-mono-200/50 dark:hover:bg-mono-500/50"
                      aria-label="Instagram"
                      whileHover={{ scale: 1.1, rotate: 3 }}
                      whileTap={{ scale: 0.95 }}
                    >
