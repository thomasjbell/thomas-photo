...
const navPages = {
  class: {
    classname:
      "bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 hover:bg-slate-300 transition-colors duration-200 text-slate-700 dark:text-slate-300 px-4 py-2 rounded-full border border-slate-100 hover:border-slate-200 dark:border-slate-700 dark:hover:border-slate-600",
  },
